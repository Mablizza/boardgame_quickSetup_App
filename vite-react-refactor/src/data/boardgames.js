export const bgCollection = [
    ...
    details: {
        ...
        player_setup: 
            ...
            2: `Place Player's trucks in 'The Depot'.`,
    ...
    details: {
        board_setup: 
            ...
            4.9: `Place the Association board next to the game board, leaving enough room for one row of cards above and one row of cards below the board. </br>5.1 - Place 1 partner zoo of each continent and 1 university of each kind on the spaces provided on the Association board. </br>5.2 -Shuffle the Base Conservation Project cards and place them face-down as a deck next to the Association board. In a 4-player game, place the 4 topmost cards face up below the board, otherwise the 3 topmost. </br>5.3 - In a 2-player game, take 6 player tokens of any unused color and cover: </br> ___A) on the face-up Base Conservation Project cards: the left level on the left card, the middle level on the middle card, and the right level on the right card. </br> ___B) on the Association board: the three spaces in the left column of the donation area. </br>The covered levels / spaces are considered blocked and cannot be used by either player.`,
        ...
        player_setup: 
            {
            0: ` Take a random Map A zoo map, and place it with that side up in front of you. Return the remaining zoo maps to the box. They are not used in this game.`,
            1: ` Take one set of Action cards each, consisting of the card types Build, Cards, Animals, Association, and Sponsors. Place one card with side I up under each of the five card slots on your zoo map: the Animals card under the slot furthest to the left showing the [1 inside a binder] and the remaining cards randomly distributed under the other 4 slots. `,
            2: ` Choose a color and take all components of this color: </br>3.1 - Place the counters for appeal, conservation , and reputation on the first spaces of their tracks on the game board. Place your counters on the Appeal track according to turn order: The start player starts on space 0 on the track; the second player in turn order starts on space 1; third on space 2 and fourth, on space 3. </br>3.2 - Take 7 of the player tokens in your color and place them on the designated spaces at the left edge of your zoo map. Keep the remaining player tokens next to your zoo map for later use. </br>3.3 - Take the 4 association workers and place 1 on the notepad of your zoo map, as the active worker, and the remaining 3 lying down on the designated spaces below the notepad.`,
            3: `Take 25 money from the supply and put it on the notepad of your zoo map.`,
            4: `Draw 2 Final Scoring cards and place them next to your zoo map. You may look at them at any time, but make sure to keep them hidden from the other players.`,
            5: `Draw 8 Zoo cards. Choose 4 of them to keep as hand cards and discard the remaining 4 cards to a face-up discard pile on the discard space on the board. Make sure to keep your hand cards hidden from the other players.`,
            6: `After you have all chosen your hand cards, reveal the 6 cards on the display.`,
            },
        player_turns: 
            {
            0: `On your turn, choose one of your Action cards to perform its action, shift it to be lower than the others in the row, then perform the action of that card with a strength of . After completing the action, remove the chosen Action card from its slot, shift all Action cards to the left of the newly empty slot to the right, and place the chosen Action card in the now-empty slot 1 `,
            1: `You may use X-tokens to increase the strength of an action. For each X-token you use, increase the strength of the action by 1. Some actions are not improved by strength greater than 5. `,
            2: `You may not "do nothing" with your action (e. g. play 0 Animal cards or build 0 buildings).`,
            3: `<span class='bold'>[BREAK]</span> - Take turns, taking 1 turn at a time, until the Break token has advanced to the last space of the Break track . An Action card, Sponsor card, or Animal card effect could cause this to happen. If you trigger the break, complete your current turn, take the Break token, and then all players perform the following steps in order: </br>•<span class='bold'>Hand Limit</span> - if you have more cards in your hand than your hand limit allows, discard any surplus cards of your choice from your hand to the discard pile. Normally your hand limit is 3, but a particular university allows you to hold 5. </br>•<span class='bold'>Tokens on Action cards:</span> If you have Multiplier, Venom, and/or Constriction tokens on your Action cards, return them to the supply. They no longer have any effect. </br>•<span class='bold'>Association board:</span> Return all your association workers from the Association board to the notepad on your zoo map. They become available to you again as active workers. Replenish the display of partner zoos and universities so that exactly one of each partner zoo and university is now available again.There is no need to replenish universities and partner zoos that all players already have. </br>•<span class='bold'>Replenish display:</span> Discard the two bottom cards of the display (folders 1 and 2) to the discard pile, move the remaining cards down and replenish the display. </br>•<span class='bold'>Take income:</span> Collect income according to the appeal of your zoo. Collect all the income indicated by the [HAND] icon. Collect income for each of the kiosks on your zoo map in the following way: Take 1 money for each unique building, special enclosure, occupied standard enclosure, and pavilion adjacent to it. A building must share at least one side of one space with a kiosk in order to be considered adjacent to it. An empty standard enclosure does not provide income (but an empty special enclosure does). </br>•<span class='bold'>Break track:</span> Return the Break token to the starting space for your player count. Then the break ends, and the game continues with the next player in clockwise order taking their next turn.`,
        },
    ...
    details: {
        ...
        player_setup: 
            ...
            3: `Place the matching coloured Link tiles in your player area.`,
            4: `Stack the matching coloured Industry tiles (which consist of Cotton Mills, Coal Mines, Iron Works, Manufacturers, Potteries , and Breweries) on their appropriate slots on your Player Mat. The side of the tiles with the black top half should be face down.`,
            5: `Place your Victory Point (VP) Marker on the "0" space of the Progress Track.`,
            6: `Place your Income Marker on the "10" space of the Progress Track.`,
            7: `Draw 8 cards from the Draw Deck; this is your Hand. Do not reveal your Hand to other players.`,
            8: `Draw 1 additional card from the Draw Deck and place it face down in your player area; this is your Discard Pile.`,
            9: `After all players have set up their player area, shuffle all players' Character tiles together and place them in a random order on the Turn Order Track`,
            },
        player_turns: 
            {
            ...
            5: `<span class='bold'>END OF ROUND.</span> After all players have taken their turn, perform the following steps before moving on to the next round: </br>•<span class='bold'>[TURN ORDER]</span> Player who spent the least will go first and so on. </br>•<span class='bold'>[TAKE INCOME]</span> Take money from the Bank equal to your income level. (Income is not collected at the end of the final round of the game.) `,
            6: `<span class='bold'>END OF CANAL ERA.</span> </br>• Remove all level 1 Industry tiles from the board. </br>• Place 1 beer barrel on each empty beer barrel space beside a (non-blank) Merchant tile. </br>• Shuffle all players' Discard Piles together and place the cards face down on the appropriate Card Draw Area. </br>• Each player draws 8 cards from the newly shuffled Draw Deck`,    
            7: `<span class='bold'>END OF CANAL / RAIL ERA.</span> </br>• For each of your Link tiles, score 1 VP for each displayed in adjacent locations, by advancing your VP Marker along the Progress Track. </br>• Remove Link tiles from the board as they are scored. </br>• After all players have removed their Link tiles, score the VPs shown in the bottom left corner of your flipped Industry tiles (those with a black top half) on the board, by advancing your VP Marker along the Progress TrackH . </br>• Unflipped Industry tilesI do not score.`,
        },
    ...
    details: {
        ...
        player_setup: 
            ...
            3: `1 worker on each territory connected to home base.`,
            4: `Player with lowest number on player mat goes first.`,
            },
        player_turns: 
            {
            ...
            4: `<span class='bold'>MOVE DETAILS.</span> Move 2 units 1 territory, or, gain a coin. </br>• All units may pick up/drop off any number of resources </br>• Mechs can pick up/drop off workers </br>• Tunnels are considered adjacent </br>• Workers cannot enter Enemy Territory. Factory / Encounters are taken by Character only.`,
            5: `<span class='bold'>COMBAT.</span> Occurs if character/mechs share territory, at end of players move action (before bottom row action): </br><span class='bold'>A)</span> Attacking player mech ability first, then defender. Attacker wins ties. </br><span class='bold'>B)</span> Select power: Up to power track number, or max 7. </br><span class='bold'>C)</span> Add cards: 1 car per unit (character/mech). </br><span class='bold'>D)</span> Reveal, pay the amount of power selected, discard combat cards. </br><span class='bold'>E)</span> Winner: Takes control of territory and resources there, gain 1 star for combat win. Lose 1 popularity for each enemy worker that retreated. Resolve encounter on territory (if applicable). </br><span class='bold'>F)</span> Loser: Retreat all units (generally to home base), leave resources behind. If revealed at least 1 power on dial/combat card, gain one combat card. </br><span class='bold'>G)</span> 6th Star: If you place your 6th star but have remaining unresolved combats, move those units back to the territory they moved from. `,
            6: `<span class='bold'>CLARIFICATIONS.</span> Player may make agreements and exchange coins. Agreements are not binding. Territory Control is having at least one unit there, or structure with no enemy units there. Resources remain on board, must have control to spend them. Workers do not combat. Banned Combinations are Rusviet and Industrial / Crimea and Patriotic. Control doesn't matter for Structure Bonus; Rivers don't break adjacency.`
            },
